...
_codelabs_cross_build_binutils() {
...
_codelabs_cross_build_bootstrap_gcc() {
...
_codelabs_cross_build_kernel_headers() {
...
_codelabs_cross_build_glibc_headers() {
...
_codelabs_cross_build_libucontext() {
...
_codelabs_cross_test_gcc_ver() {
	local ver basever
	_codelabs_cross_test_ver gcc
	ver=$(cat .gcc_version)
...
do_build() {
	...
	_codelabs_cross_test_ver binutils
	_codelabs_cross_test_ver linux
	_codelabs_cross_test_gcc_ver
	...
	_codelabs_cross_build_binutils ${tgt} ${binutils_ver}
	...
	_codelabs_cross_build_bootstrap_gcc ${tgt} ${gcc_ver}
	_codelabs_cross_build_kernel_headers ${tgt} ${linux_ver}
	...
	if [ -f ${wrksrc}/.musl_version ]; then
		_codelabs_cross_build_musl ${tgt} ${libc_ver}
		_codelabs_cross_build_libucontext ${tgt} ${libucontext_ver}
	else
		_codelabs_cross_build_glibc_headers ${tgt} ${libc_ver}
		_codelabs_cross_build_glibc ${tgt} ${libc_ver}
	fi

	_codelabs_cross_build_gcc ${tgt} ${gcc_ver}
