# Cycle detector for codelabs-packages

This script enumerates dependencies for packages in a
[codelabs-packages repository](https://github.com/codelabs/codelabs-packages)
...
provide the path to your desired codelabs-packages clone.
