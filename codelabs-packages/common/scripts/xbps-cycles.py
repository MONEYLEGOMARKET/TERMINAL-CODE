...
def enum_depends(pkg, xbpsdir, cachedir):
	...
	be a path to a codelabs-packages repository. Dependencies will be
...
def find_cycles(depmap, xbpsdir):
	...
	The argument xbpsdir should be a path to the root of a codelabs-packages
...
if __name__ == '__main__':
	...
	parser.add_argument('-d', '--directory',
			default=None, help='Path to codelabs-packages repo')
